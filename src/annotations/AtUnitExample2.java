...
public class AtUnitExample2 {
  ...
  public static void main(String[] args) throws Exception {
    String path = AtUnitExample2.class.getProtectionDomain().getCodeSource().getLocation().getPath();
    OSExecute.command(
            "java -cp $CLASS_PATH;"+ path +";"+ path+"lib/ net.mindview.atunit.AtUnit out/production/jdk_study/annotations/AtUnitExample2");
  }
} /* Output:
